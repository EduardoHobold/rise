...
class PresencaAulasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create presenca_aula" do
    assert_difference('PresencaAula.count') do
      post presenca_aulas_url, params: { presenca_aula: { aluno_id: @presenca_aula.aluno_id, aula_id: @presenca_aula.aula_id } }
    end
  ...
  test "should update presenca_aula" do
    patch presenca_aula_url(@presenca_aula), params: { presenca_aula: { aluno_id: @presenca_aula.aluno_id, aula_id: @presenca_aula.aula_id } }
