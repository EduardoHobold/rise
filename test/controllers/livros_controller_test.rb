...
class LivrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create livro" do
    assert_difference('Livro.count') do
      post livros_url, params: { livro: { autor: @livro.autor, editora: @livro.editora, nome: @livro.nome, paginas: @livro.paginas, sinopse: @livro.sinopse } }
    end
  ...
  test "should update livro" do
    patch livro_url(@livro), params: { livro: { autor: @livro.autor, editora: @livro.editora, nome: @livro.nome, paginas: @livro.paginas, sinopse: @livro.sinopse } }
