...
class MatriculasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create matricula" do
    assert_difference('Matricula.count') do
      post matriculas_url, params: { matricula: { curso_id: @matricula.curso_id, ra: @matricula.ra } }
    end
  ...
  test "should update matricula" do
    patch matricula_url(@matricula), params: { matricula: { curso_id: @matricula.curso_id, ra: @matricula.ra } }
