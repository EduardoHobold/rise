...
class ProfessoresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post professores_url, params: { professor: { disciplina_id: @professor.disciplina_id, pessoa_id: @professor.pessoa_id } }
    end
  ...
  test "should update professor" do
    patch professor_url(@professor), params: { professor: { disciplina_id: @professor.disciplina_id, pessoa_id: @professor.pessoa_id } }
